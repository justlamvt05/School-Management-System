  ...
  List<_MenuItem> _buildMenuItems() {
    return [
      _MenuItem(
        ...
        color: _purple,
        builder: () => CalendarPage(token: widget.token),
      ),
      _MenuItem(
        label: 'Bảng điểm',
        icon: Icons.bar_chart_rounded,
        color: _amber,
        builder: () => MarkReportPage(token: widget.token),
      ),
      _MenuItem(
        label: 'Câu lạc bộ',
        icon: Icons.group_rounded,
        color: _blue,
        builder: () => ClubPage(token: widget.token),
      ),
      _MenuItem(
        label: 'Sự kiện',
      ...
      _MenuItem(
        ...
        color: _red,
        builder: () => ApplicationPage(token: widget.token),
      ),
      _MenuItem(
        label: 'Điểm danh',
        icon: Icons.co_present_rounded,
        color: _green,
        builder: () => AttendancePage(token: widget.token),
      ),
    ];
  }
              ...
              children: [
                Text(
                  _isLoadingProfile
                      ? 'Đang tải...'
                      : (_userProfile != null
                            ? ' Học Sinh ${_userProfile!.fullName}'
                            : ''),
