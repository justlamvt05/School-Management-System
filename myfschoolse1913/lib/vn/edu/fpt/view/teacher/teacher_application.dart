...
class TeacherApplication extends StatefulWidget {
  ...
  const TeacherApplication({super.key, required this.token});

  @override
  State<TeacherApplication> createState() => _TeacherApplicationState();
}
...
class _TeacherApplicationState extends State<TeacherApplication> {
  ...
  static final List<_ApplicationType> _applicationTypes = [
    ...
    _ApplicationType(
      ...
      label: 'Xin đổi lịch dạy',
      typeKey: 'SCHEDULE_CHANGE',
      color: _yellow,
    ),
    _ApplicationType(
      icon: Icons.people_alt_outlined,
      label: 'Xin giáo viên dạy thay',
      typeKey: 'SUBSTITUTE_REQUEST',
      color: Color(0xFF4CAF50),
    ),
    _ApplicationType(
      icon: Icons.access_time_filled_rounded,
      label: 'Đăng ký làm thêm giờ',
      typeKey: 'OVERTIME_REQUEST',
      color: Color(0xFFFF9800),
    ),
    _ApplicationType(
      icon: Icons.computer_outlined,
      label: 'Xin cấp thiết bị',
      typeKey: 'EQUIPMENT_REQUEST',
      color: Color(0xFF00BCD4),
    ),
    _ApplicationType(
      icon: Icons.school_outlined,
      label: 'Đăng ký tập huấn',
      typeKey: 'TRAINING_REQUEST',
